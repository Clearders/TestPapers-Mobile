...
part 'question_bank_summary.g.dart';
...
/// * [visibility]
@BuiltValue()
abstract class QuestionBankSummary
    implements Built<QuestionBankSummary, QuestionBankSummaryBuilder> {
  ...
  QuestionBankSummary._();

  factory QuestionBankSummary([void updates(QuestionBankSummaryBuilder b)]) =
      _$QuestionBankSummary;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(QuestionBankSummaryBuilder b) => b
    ..hasUpdate = false
    ..isSubscribed = false
    ..itemCount = 0
    ..memberCount = 0
  ...
  static Serializer<QuestionBankSummary> get serializer =>
      _$QuestionBankSummarySerializer();
}

class _$QuestionBankSummarySerializer
    implements PrimitiveSerializer<QuestionBankSummary> {
  @override
  ...
  @override
  final String wireName = r'QuestionBankSummary';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    QuestionBankSummary object, {
  ...
  void _deserializeProperties(
    ...
    required QuestionBankSummaryBuilder result,
  ...
  @override
  QuestionBankSummary deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = QuestionBankSummaryBuilder();

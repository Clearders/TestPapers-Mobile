...
part 'paper_draft_question.g.dart';
...
/// * [type]
@BuiltValue()
abstract class PaperDraftQuestion
    implements Built<PaperDraftQuestion, PaperDraftQuestionBuilder> {
  ...
  PaperDraftQuestion._();

  factory PaperDraftQuestion([void updates(PaperDraftQuestionBuilder b)]) =
      _$PaperDraftQuestion;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaperDraftQuestionBuilder b) => b
    ..difficulty = Difficulty.medium
    ..hasLatex = false
    ..scoreWeight = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaperDraftQuestion> get serializer =>
      _$PaperDraftQuestionSerializer();
}

class _$PaperDraftQuestionSerializer
    implements PrimitiveSerializer<PaperDraftQuestion> {
  @override
  final Iterable<Type> types = const [PaperDraftQuestion, _$PaperDraftQuestion];

  @override
  final String wireName = r'PaperDraftQuestion';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PaperDraftQuestion object, {
  ...
  void _deserializeProperties(
    ...
    required PaperDraftQuestionBuilder result,
  ...
  @override
  PaperDraftQuestion deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaperDraftQuestionBuilder();

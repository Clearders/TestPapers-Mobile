...
/// * [type]
@BuiltValue()
abstract class QuestionCreate
    implements Built<QuestionCreate, QuestionCreateBuilder> {
  ...
  factory QuestionCreate([void updates(QuestionCreateBuilder b)]) =
      _$QuestionCreate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(QuestionCreateBuilder b) => b..scoreWeight = 1.0;

  @BuiltValueSerializer(custom: true)
  static Serializer<QuestionCreate> get serializer =>
      _$QuestionCreateSerializer();
}

class _$QuestionCreateSerializer
    implements PrimitiveSerializer<QuestionCreate> {
  @override
  final Iterable<Type> types = const [QuestionCreate, _$QuestionCreate];

  @override
  final String wireName = r'QuestionCreate';
  ...
  void _deserializeProperties(
    ...
    required QuestionCreateBuilder result,
  ...
  @override
  QuestionCreate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = QuestionCreateBuilder();

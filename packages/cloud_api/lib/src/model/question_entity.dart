...
abstract class QuestionEntity
    implements Built<QuestionEntity, QuestionEntityBuilder> {
  ...
  factory QuestionEntity([void updates(QuestionEntityBuilder b)]) =
      _$QuestionEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(QuestionEntityBuilder b) => b..scoreWeight = 1.0;

  @BuiltValueSerializer(custom: true)
  static Serializer<QuestionEntity> get serializer =>
      _$QuestionEntitySerializer();
}

class _$QuestionEntitySerializer
    implements PrimitiveSerializer<QuestionEntity> {
  @override
  final Iterable<Type> types = const [QuestionEntity, _$QuestionEntity];

  @override
  final String wireName = r'QuestionEntity';
  ...
  void _deserializeProperties(
    ...
    required QuestionEntityBuilder result,
  ...
  @override
  QuestionEntity deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = QuestionEntityBuilder();

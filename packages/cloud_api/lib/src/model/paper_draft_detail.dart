...
part 'paper_draft_detail.g.dart';
...
/// * [updatedBy]
@BuiltValue()
abstract class PaperDraftDetail
    implements Built<PaperDraftDetail, PaperDraftDetailBuilder> {
  ...
  BuiltList<PaperDraftCollaboratorEntity>? get collaborators;

  @BuiltValueField(wireName: r'commentCount')
  int get commentCount;

  @BuiltValueField(wireName: r'comments')
  BuiltList<PaperDraftCommentEntity>? get comments;
  ...
  factory PaperDraftDetail([void updates(PaperDraftDetailBuilder b)]) =
      _$PaperDraftDetail;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaperDraftDetailBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaperDraftDetail> get serializer =>
      _$PaperDraftDetailSerializer();
}

class _$PaperDraftDetailSerializer
    implements PrimitiveSerializer<PaperDraftDetail> {
  @override
  final Iterable<Type> types = const [PaperDraftDetail, _$PaperDraftDetail];

  @override
  final String wireName = r'PaperDraftDetail';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PaperDraftDetail object, {
  ...
  void _deserializeProperties(
    ...
    required PaperDraftDetailBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'collaboratorCount':
          ...
          break;
        case r'collaborators':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(
                BuiltList, [FullType(PaperDraftCollaboratorEntity)]),
          ) as BuiltList<PaperDraftCollaboratorEntity>?;
          if (valueDes == null) continue;
          result.collaborators.replace(valueDes);
          break;
        case r'commentCount':
          final valueDes = serializers.deserialize(
            value,
        ...
        case r'comments':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(
                BuiltList, [FullType(PaperDraftCommentEntity)]),
          ) as BuiltList<PaperDraftCommentEntity>?;
          if (valueDes == null) continue;
  ...
  @override
  PaperDraftDetail deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaperDraftDetailBuilder();
